...
{
    // This Script and the WallRun2 script are meant for the same purpose!!!
    [Header("Wall Running")]
    ...
    private void OnCollisionStay(Collision collision)
    {
        if (collision.transform.CompareTag("RunnableWall"))
        {
            ...
            {
                rb.AddForce(Vector3.up * _wallRunUpForce * Time.deltaTime);
                rb.AddForce(head.transform.right * _wallRunPushForce * Time.deltaTime);
            }
